...
const StudentList = () => {
    ...
    const fetchUsers = async () => {
        try {
            ...
            let apiUrl = 'http://localhost:5000/api/teacher/get-students-list';
            if (className) {
            ...
            <Container maxWidth="lg" sx={{ pt: 4, pb: 4 }}>
                ...
                <Box sx={{ mb: 3, display: 'flex', alignItems: 'center', gap: 2 }}>
                    ...
                    <Typography variant="h4" sx={{ fontWeight: 'bold', color: '#2c3e50' }}>
                        {className ? `Students - ${className}` : 'All Students'}
                    </Typography>
                </Box>
                    ...
                    <Box sx={{ mb: 2, px: 1 }}>
                        <Typography variant="body2" color="textSecondary">
                            {filteredusers.length === 0
                                ...
                                : `Showing ${filteredusers.length} of ${users.length} student${filteredusers.length !== 1 ? 's' : ''}`
                            }
                        </Typography>
                    </Box>
                )}
                ...
                {filteredusers.length > 0 && (
                    <Box sx={{
                        ...
                        <Typography variant="body1" sx={{ fontWeight: 500, color: '#2c3e50' }}>
                            Total: {userCounts.total} Student{userCounts.total !== 1 ? 's' : ''}
                        </Typography>
                    </Box>
                )}
            </Container>
